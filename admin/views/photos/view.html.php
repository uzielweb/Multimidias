...
{
	/**
	 * Photos view display method
	 * @return void
	 */
	function display($tpl = null) 
	{
		// Include helper submenu
		MultimidiasHelper::addSubmenu('photos');
	...
	protected function addToolBar() 
	{
		...
		if($canDo->get('core.create')){
			JToolBarHelper::addNew('photodetail.add', 'JTOOLBAR_NEW');
		};
		if($canDo->get('core.edit')){
			JToolBarHelper::editList('photodetail.edit', 'JTOOLBAR_EDIT');
		};
