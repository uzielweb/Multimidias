...
$edit = "index.php?option=com_multimidias&view=videos&task=videodetail.edit";
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td>
			...
			<?php if ($item->checked_out){ ?>
				<?php echo JHtml::_('jgrid.checkedout', $i, $userChkOut->name, $item->checked_out_time, 'videos.', $canCheckin); ?>
			<?php } ?>
		</td>
		<td>
