 ...
 * Videos View
 */
class MultimidiasViewvideos extends JViewLegacy
{
	/**
	 * Videos view display method
	 * @return void
	 */
	function display($tpl = null) 
	{
		// Include helper submenu
		MultimidiasHelper::addSubmenu('videos');
	...
	protected function addToolBar() 
	{
		...
		if($canDo->get('core.create')){
			JToolBarHelper::addNew('videodetail.add', 'JTOOLBAR_NEW');
		};
		if($canDo->get('core.edit')){
			JToolBarHelper::editList('videodetail.edit', 'JTOOLBAR_EDIT');
		};
