...
class MultimidiasViewdocument extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('Document :: New') : JText::_('Document :: Edit'), 'document');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('Document :: New :: Administrator') : JText::_('Document :: Edit :: Administrator'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_multimidias/views/document/submitbutton.js");
		JText::script('document not acceptable. Error');
	}
}
?>