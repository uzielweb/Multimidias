...
<form action="<?php echo JRoute::_('index.php?option=com_multimidias&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
				...
				<div class="adminformlist">
					<?php foreach($this->form->getFieldset('details') as $field){ ?>
						<div>
							...
							<?php if($field->fieldname == 'file' && $field->value){ ?>
							<label>Delete Image</label><input type="checkbox" name="file_delete" value="1" />
	...
	<div>
		<input type="hidden" name="task" value="photodetail.edit" />
